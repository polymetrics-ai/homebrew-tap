...
- PM formula updates must use immutable `polymetrics-ai/cli` tag archives with checked SHA-256 values and linker metadata that matches the upstream release.
